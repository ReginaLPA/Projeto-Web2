...
import { createPontoHistorico } from '../../redux/actions/pontosHistoricosActions'

function CreatePontoHistorico() {
    ...
    async function handleCreateNewPontoHistorico(e: FormEvent) {
        e.preventDefault()
        ...
        dispatch(createPontoHistorico(data, push))
    }
    ...
    return(
        <div id="page-create-PontoHistorico">
            ...
            <main>
                ...
                <form onSubmit={handleCreateNewPontoHistorico} className="PontoHistorico-details">
                    <h2>Dados</h2>
...
export default CreatePontoHistorico